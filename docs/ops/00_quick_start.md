...
4. M1 Issue 9 AWS Load Balancer Controller, M1 Issue 10 ArgoCD/Grafana HTTPS Admin Ingress, M1 Issue 12 `runtime-config.yaml` 구조 초안, M3 Issue 1~5 배포 기준선, M4 Issue 1 Raw/Processed 데이터 계약 확정은 완료됐다. 다음 작업은 M4 Issue 2 `factory-a-log-adapter` 구현이다.
