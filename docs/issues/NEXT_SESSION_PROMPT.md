...
8. apps/data-processor/ 확인
9. apps/daily-report-generator/ 확인
...
- 2026-05-29 점검 결과 `factory-a`는 2026-05-28T07:54Z 이후 IoT 입력이 중단된 상태다. stale LATEST 100점 문제는 refresh 배포로 해결되어 현재 `pipeline_status=critical`, `risk.score=0`, `risk.level=danger`로 갱신된다. 다음 세션에서 factory-a data-plane Pod/Secret/outbox/publisher 복구 여부를 확인한다.
...
5. Daily Factory Report 고도화 후보를 진행한다.
