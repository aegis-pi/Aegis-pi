...
4. 이후 M1 Issue 9 AWS Load Balancer Controller 준비와 M1 Issue 10 ArgoCD/Grafana HTTPS Admin Ingress 구성 단계로 넘어간다. `runtime-config.yaml` 구조 초안은 M1 Issue 12에서 진행한다.
