...
| 경로 | 역할 |
| --- | --- |
| `foundation/` | S3, AMP, ECR, DynamoDB처럼 Hub EKS destroy와 분리되는 영속 리소스 Terraform 구성. Hub를 내려도 유지한다 |
...
| `hub/` | Control / Management VPC, subnet, NAT Gateway, EKS, node group Terraform 구성 |
