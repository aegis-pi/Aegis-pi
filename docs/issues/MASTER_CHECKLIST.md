...
- [x] Issue 5 - [Spoke/Dummy Generator] 로컬 Dummy data generator 구현 및 실행
- [x] Issue 6 - [배포/ArgoCD] 테스트베드형 동기화 정책 및 자동 롤백 적용
- [x] Issue 7 - [검증/데이터] `factory-b`, `factory-c` 데이터 플레인 연결 확인
