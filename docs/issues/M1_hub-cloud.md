...
- VPC: `vpc-072af07bfcd7b4ca0`
- Private subnets: `subnet-0c82c49755fd50b6f`, `subnet-0e8564c76de0a1223`
- Public subnets: `subnet-0b03c3b742613811e`, `subnet-0868a3b22f5acf6c3`
...
- 현재 AWS에는 Hub EKS와 namespace가 active 상태다. destroy/recreate 이후에는 `scripts/build/build-hub.sh`가 Terraform apply와 Ansible bootstrap을 순서대로 수행한다.
...
2026-05-06 `build-all` 재실행 이후 Hub EKS와 ArgoCD는 active 상태다.
...
- 다음 작업: Issue 6의 AMP Workspace 생성 및 Prometheus/Agent remote_write 권한 준비
