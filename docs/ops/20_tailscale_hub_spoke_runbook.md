...
Tailscale은 관리자 대시보드 접근망이 아니다. Dashboard Web/API는 Data / Dashboard VPC에서 제공하고, DynamoDB LATEST/GRAPH#5M/HISTORY#STATE와 S3 processed/processed_agg만 read-only로 조회한다.
