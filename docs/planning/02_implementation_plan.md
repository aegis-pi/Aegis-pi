...
- `scripts/build/build-hub.sh`를 실행해 VPC, NAT Gateway, EKS, node group을 생성하고, 유지 중인 data-pipeline이 있으면 SlowCollector EKS access binding을 자동 복구한다.
