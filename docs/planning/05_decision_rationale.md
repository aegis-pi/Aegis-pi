...
s3://<bucket>/
  ...
  processed/factory-a/risk_score/yyyy=2026/mm=05/dd=04/hh=HH/<message_id>.json
  processed/factory-a/state_snapshot/yyyy=2026/mm=05/dd=04/hh=HH/<updated_at>.json
```
