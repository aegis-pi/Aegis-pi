...
| 후속 범위 | AWS Hub, `factory-b`, `factory-c`, IoT Core, S3, Risk Twin |
...
후속 확장에서는 IoT Core, S3, AMP/Grafana, Risk Score Engine, ApplicationSet 기반 배포를 추가한다.
...
| Phase 4 (M3~M4) | 배포/데이터 파이프라인 확장 | 대기 |
...
7. `docs/issues/M0_factory-a_safe-edge-baseline.md`
