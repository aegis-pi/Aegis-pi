...
- AWS Hub EKS/VPC/namespace/ArgoCD bootstrap, Hub Prometheus Agent, 내부 Grafana/AMP datasource, foundation S3/AMP/IoT Rule, IRSA S3/AMP 권한은 2026-05-06 기준 `build-all`로 재생성되어 active 상태이고, Dashboard VPC/Risk Twin 구조는 아직 후속 단계다.
